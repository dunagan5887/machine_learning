...
test_list = [1,4,7]
test_list_rdd = sc.parallelize(test_list)
test_list_rdd.cache()


print "\n\nClustering for crash_plus_12_periods_leading_up ON MASTER SCRIPT\n\n\n"



close_prices_for_span = symbolCollectionInstance.getSymbolSpanValueVectors('crash_plus_12_periods_leading_up', 'close_price')
...
print "\n\nPrinting Cluster Centers ON MASTER SCRIPT\n\n\n"


print clusterCenters


print "\n\nPrinting Cluster Groups ON MASTER SCRIPT\n\n\n"
